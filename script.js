                        ...
                        newPosts += `
                            <div class="post">
                                <div class="post-header">
                                    <div class="post-user">
                                        <a href="profile.html?user=${post.userId}">
                                            ...
                                            <span class="post-username">${response.username}</span>
                                        </a>
                                    </div>
                                </div>
                                <div>
                                        ...
                                        <!-- Modal content -->
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <textarea name="add-comment" id="add-comment" class="add-comment"></textarea>
                                ...
                                <div class="post-comment">${allComments}
                                    <span class="bold-text">${post.description}</span>
                                </div>
                            </div>
                        `
                        ...
                        for (let i = 0; i < likeBtns.length; i++) {
                            ...
                            likeBtn.addEventListener('click', () => {
                                ...
                                if (!isLiked) {
                                    ...
                                    // Supprimer le like
                                    fetch(`https://insta-api-api.0vxq7h.easypanel.host/posts/${postId}/likes`, {
                                        method: 'DELETE'
                                    })
                                    .then(() => {
                                        // Mettre à jour l'apparence de l'icône du cœur
                                        likeBtn.classList.remove('post-icon-heart-red');
                                    })
                                }
                            })
                        }    
